...
def test_3AP05():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/3AP05.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 12
...
def test_4AP05():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/4AP05.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 33
...
def test_ozlen_2014_paper():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/ozlen_2014_paper.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 14
...
def test_ozlen_2014_paper_as_max():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/ozlen_2014_paper.as.max.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 14
    assert (-19, -15, -14, -11) in nds
    assert (-18, -15, -15, -9) in nds
...
def test_tamby_vanderpooten_paper():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/tamby_vanderpooten_2020.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 7
...
def test_2KP50():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/2KP50.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 43
...
def test_3KP10():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/3KP10.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 6
...
def test_4KP10():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/4KP10.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 11
...
def test_3AP_15_1():
    optimiser = Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/pettersson_ozlen_2017_examples/AP3_Tests/3AP-15-1.lp')
    nds = optimiser.find_non_dominated_objective_vectors()
    assert len(nds) == 506
...
def test_ideal_point():
    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/2AP05.lp')._ideal_point) == (21, 24)
    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/3AP05.lp')._ideal_point) == (21, 24, 31)
    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/4AP05.lp')._ideal_point) == (21, 24, 31, 21)

    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/ozlen_2014_paper.lp')._ideal_point) == (11, 8, 7, 9)
    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/ozlen_2014_paper.as.max.lp')._ideal_point) == (11, 8, 7, 9)

    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/2KP50.lp')._ideal_point) == (-2414, -2450)
    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/3KP10.lp')._ideal_point) == (-474, -336, -410)
    assert(Tamby2020TwoStageMOIPtimiser.from_lp_file('tests/examples/4KP10.lp')._ideal_point) == (-474, -336, -410, -524)
